    ...
    var body: some View {
        VStack(spacing: FTSpacing.lg) {
            ...
            if !wasteAnalyses.isEmpty {
                VStack(alignment: .leading, spacing: FTSpacing.sm) {
                    BillsSectionHeader(title: "AI Insights", symbol: "sparkles", tint: FTColor.gold)
                        .padding(.horizontal, FTSpacing.screen)
            ...
            if !autoPayMissedBills.isEmpty {
                VStack(alignment: .leading, spacing: FTSpacing.sm) {
                    BillsSectionHeader(title: "Auto-Pay Alerts", symbol: "exclamationmark.triangle.fill", tint: .orange)
                        .padding(.horizontal, FTSpacing.screen)
            ...
            if !priceChangedBills.isEmpty {
                VStack(alignment: .leading, spacing: FTSpacing.sm) {
                    BillsSectionHeader(title: "Price Changes", symbol: "arrow.up.right.circle.fill", tint: FTColor.expense)
                        .padding(.horizontal, FTSpacing.screen)
...
private struct BillsSectionHeader: View {
    let title: String
    let symbol: String
    let tint: Color
