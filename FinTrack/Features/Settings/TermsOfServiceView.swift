...
struct TermsOfServiceView: View {
    ...
    private let sections: [(title: String, body: String)] = [
        ...
        ("Data Responsibility", "You are solely responsible for the accuracy of data you enter into FinTrack. The app stores data locally on your device. Loss of data due to device failure, iOS updates, or accidental deletion is your responsibility. We strongly recommend enabling Offline Backup and keeping a copy of a backup file somewhere safe."),
