...
- LocalBackupView.swift — offline backup hub: status, Back Up Now, automatic-daily toggle, saved-backup list (restore / share to Files / delete). Replaced `iCloudSyncView`.
